...
clear
toilet --metal "SkyFish"
xdg-open  https://t.me/SkyFish404
echo '[+] Author : SkyFish'
echo '[+] Team : Gabut'
echo '[+] Github : https://www.github.com/404SkyFish'
echo ''
echo '[][][][][][][][]][][][][][][][][][][][][][][][][][][][][]'
...
<p><br><br><br><br><center></b><font size="3,5"<font color="white">Hacked BY <br><br><span class="blink_me"><font size="4" color="Red" face="Wallpoet" style="text-shadow: 5px 0px 30px red;">$user1</font></center></span><br><br><center><font size="1" color="grey" face="Iceberg"> </font><font size="3"<color="red" face="Iceberg">TEAM GABUT</span></font> <font size="1" color="grey" face="Iceberg"> <span style="color:white;" id="12"></span></font></center> 
...
<font face="iceberg" size="2px" color="red">PESAN |
 ...
 <br><span class="blink_me"><font size="3" color="Red" face="Wallpoet" style="text-shadow: 5px 0px 27px red;">Powered By TEAM GABUT <br><a href="https://t.me/SkyFish404">COPYRIGHT BY SkyFish<br></span></center>
<center>
<audio autoplay="autoplay" controls="controls" src="https://i.top4top.io/m_16036g6f61.mp3" type="audio/mpeg"></audio>
</center>
<center>
...
<html lang=en>
	<meta charset=UTF-8>
     ...
     <title>Hacked by $user2</title>
     <meta name="google-site-verification" content="TEAM GABUT"/>
     <meta name="theme-color" content="black">
     <meta http-equiv="Content-Type" content="text/html; charset=Windows-1254"/>
     <meta name="description" content="$user2">
     <meta name="author" content="TEAM GABUT"/>
     <meta name="keywords" content="SkyFish"/>
...
<style>
 h1{
    ...
    var text="( pesan untuk anda )<br>$pesanf<br>$pesang<br>$pesanh<br>$pesanj<br>SCRIPT BY TEAM GABUT :) "
    var delay=90;
    var currentChar=100;
...
<body>
  ...
  <canvas id="demo-canvas"></canvas>
    <h1 class="main-title">Hacked By $user4<br><span class="thin">SkyFish</span></h1>
</div>
